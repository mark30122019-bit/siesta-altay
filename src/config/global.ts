...
export const GLOBAL_CONFIG: SiteConfig = {
  ...
  manifest: {
    ...
    description:
      "В сети сотни глянцевых каталогов с купленными отзывами. «Сиеста» устроена иначе. Это не самый большой список Алтая, а единственный, где я лично зашел и отснял свой честный 3D-тур.",
    features: [
      "Без рекламной воды — только голые факты и личный опыт",
      "Честный разбор «Кому скорее всего не подойдёт» в каждой карточке",
    ],
  },
  promoTour: {
    ...
    description:
      "Каталог собран из баз, которые мы проверили лично и сняли в 3D-туре — без глянца и купленных отзывов.",
  ...
  objects: [
  {
    ...
    seo: {
      title: "Усадьба «Вельвет», Манжерок — 3D-тур и честный обзор",
  ...
  },
  {
    ...
    seo: {
      title: "Купольный глэмпинг «ВОЗДУХ», Усть-Сема — 3D-тур днём и ночью",
  ...
  },
  {
    ...
    seo: {
      title: "Парк-отель SKALA, Барангол — 3D-тур с аэропанорамой",
  ...
  },
  {
    ...
    seo: {
      title: "Усадьба Кругловых, Чепош — 3D-тур и честный обзор",
  ...
  },
  {
    ...
    seo: {
      title: "Экоотель Green Ландия, Бирюзовая Катунь — 3D-тур и обзор",
  ...
  },
  {
    ...
    seo: {
      title: "Турбаза «Алтаир», Чепош — 3D-тур и честный обзор",
