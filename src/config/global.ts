...
export const GLOBAL_CONFIG: SiteConfig = {
  ...
  manifest: {
    title: "ПОЧЕМУ СИЕСТА?",
    subtitle:
      "Единый каталог проверенных баз отдыха и экологичных эко-отелей Алтая. Мы гарантируем комфорт и уединение вашего отдыха.",
    description:
      "Наша задача — сделать ваш отдых без лишних хлопот и сэкономить время и успокоить нервы.",
    features: [
      "проверенные базы",
  ...
  promoTour: {
    ...
    badge: "Организация под ключ",
    description:
      "Комплексный премиум-тур с организацией гида, трансфера и гидом.",
