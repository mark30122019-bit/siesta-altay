export const UI_CONFIG = {
  ...
  corporate: {
    ...
    page: {
      ...
      emptyEvents:
        "Детали по залам и условиям ещё уточняем с базой — оставьте заявку, подберём вручную.",
  ...
  weddings: {
    ...
    emptySubtitle:
      "Свадебные данные ещё собираем с базами. Сбросьте фильтры или напишите нам — подберём вручную.",
    emptyReset: "Сбросить фильтры",
    buyoutYes: "Да",
    buyoutNo: "Уточняется",
    buyoutUnavailable: "Нет",
